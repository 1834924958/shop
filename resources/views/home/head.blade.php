...
?>
<html class="js rgba opacity cssanimations borderradius boxshadow csstransitions csstransforms textshadow"><head>@foreach($kai as $wlkg)
...
@endforeach
        ...
        <link rel="stylesheet" href="{{ URL::asset('css/list-88e3b36c22.css') }}">
        <link rel="stylesheet" href="{{ URL::asset('css/search-7d011836bf.css') }}">
        <link rel="stylesheet" href="{{ URL::asset('css/detail-2f2a5e27b6.css') }}">
        <link rel="stylesheet" href="{{ URL::asset('css/cart-e5395f0aef.css') }}">
                    ...
                    <div class="g-row">
                        ...
                        <div class="tab-inner">
                            <div class="m-search">
                                 ...
                                 @if( !empty(session("homeuser")) )
                                <a class="w-button-cart" href="/home/carr">
                                    <i class="w-icon-normal icon-normal-blackcart"></i>   
                                </a>
                                @else
                                    <a class="w-button-cart" href="#">
                                    <i class="w-icon-normal icon-normal-blackcart"></i>      
                                </a>
                            ...
                            <ul class="tab-nav">
                                ...
                                <li class="j-nav-item nav-item ">
                                    <a class="topLevel" href="/home/list/?id={{ $plate->id }}" title="{{ $plate->name }}">
                                        {{ $plate->name }}
                                    </a>
                                    ...
                                    <div class="j-nav-dropdown nav-dropdown">
                                        <div class="j-nav-cateCard nav-cateCard" style="width: 1519px; left: -759.5px;">
                                            ...
                                            <ul class="card-list">
                                                <li class="item">
                                                    <a class="nav-subCate" href="/home/list/?id={{ $plate->id }}#{{ $plat->pname }}" title="{{ $plat->name }}">
                                                        <img class="w-icon-50" src=".././images/child/{{ $plat->photo }}" alt="{{ $plat->name }}">
